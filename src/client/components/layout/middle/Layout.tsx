...
import useMenuItems from '@/client/components/layout/middle/useMenuItems';
import UserMenuDialog from '@/client/components/layout/middle/UserMenuDialog';
import ButtonPrimary from '@/client/components/ui/Button/ButtonPrimary';
import Dialog from '@/client/components/ui/Dialog/Dialog';
...
export default function Layout({ children }: { children: ReactNode }) {
  ...
  > = {
    ...
    reports: lazy(() => import('@/app/(middle)/(pages)/reports')),
  };
